...
const FoodCategoryList = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_ROUTES.FOOD_CATEGORIES}?${params.toString()}`,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(API_ROUTES.FOOD_CATEGORY(id), {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchCategories();
    } catch (error) {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage your food and beverage categories</p>
            </div>
          </div>
          
          <button
            onClick={() => navigate("/homepage/foodcategorycreate-edit")}
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full p-2 pl-10 border border-gray-300/50 rounded-lg bg-white/80 focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500 outline-0"
                />
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-2 border border-gray-300/50 rounded-lg bg-white/80 focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500 outline-0"
            >
            ...
            <tbody>
              {categories.length === 0 ? (
                <tr>
                  <td colSpan="6" className="py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-sm">Click "Add New Category" to create one</p>
                    </div>
                  </td>
                </tr>
              ) : (
                categories.map((category, index) => (
                  ...
                  >
                    <td className="py-3 px-4 font-medium">#{category.id}</td>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() => navigate(`/food-categories/edit/${category.id}`)}
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 bg-white/80 focus:outline-none focus:ring-2 focus:ring-orange-500/30"
                >
              ...
              <div className="text-sm text-gray-700">
                ...
                of <span className="font-semibold">{pagination.totalCount}</span> categories
              </div>
            </div>
      ...
      {isViewModalOpen && viewingCategory && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative backdrop-blur-xl bg-white/95 border border-white/60 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            {/* Modal Header */}
            <div className="sticky top-0 z-10 p-6 border-b border-white/50 bg-gradient-to-r from-orange-500/10 to-yellow-500/10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">ID: #{viewingCategory.id}</p>
                  </div>
                </div>
                <button
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div className="space-y-6">
                {/* Category Image */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Category Image</h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-white/60 rounded-lg">
                      ...
                      <p className="font-medium text-gray-800">{viewingCategory.name}</p>
                    </div>
                    <div className="p-4 bg-white/60 rounded-lg">
                    ...
                    <div className="p-4 bg-white/60 rounded-lg">
                      ...
                      <p className="font-medium text-gray-800">{formatDate(viewingCategory.createdAt)}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="sticky bottom-0 p-6 border-t border-white/50 bg-white/80">
              <div className="flex justify-end gap-3">
                <button
                  onClick={() => navigate(`/food-categories/edit/${viewingCategory.id}`)}
