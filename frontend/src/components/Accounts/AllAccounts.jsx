    ...
    <div className="min-h-screen rounded-t-2xl bg-gradient-to-br from-gray-50 via-white to-green-50 p-4 md:p-6">
      ...
      {(showDepositModal || showWithdrawModal || showTransferModal) && activeAccount && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={closeAllActionModals}></div>
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
              <div className="space-y-4">
                <input
                  ...
                  placeholder="Amount"
                  className="w-full px-4 py-2.5 bg-white/60 backdrop-blur-sm border border-gray-200/60 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
                />
                {showTransferModal && (
                  <select
            ...
            <div className="sticky bottom-0 p-6 border-t border-white/50 bg-white/70">
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-green-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-emerald-600 hover:to-green-600 transition-all duration-300 disabled:opacity-50"
                >
