...
const SupplierReport = () => {
  ...
  const handleExport = () => {
    ...
    const csvContent = "data:text/csv;charset=utf-8," 
      + [["Supplier", "Mobile", "Items (Qty)", "Item Types", "Total Paid", "Total Due"], 
         ...rows.map(r => [r.name, r.mobile || "-", r.totalItemQty, r.itemTypeCount, r.totalPaid, r.totalDue])]
          .map(e => e.join(",")).join("\n");
  ...
  const activeSuppliers = rows.filter(r => Number(r.totalItemQty || 0) > 0).length;
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    Showing {showingStart}-{showingEnd} of {filteredRows.length} suppliers
                  </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-sm text-gray-700">
                      ...
                      <span className="font-semibold">{filteredRows.length}</span> suppliers
                    </div>
                  </div>
