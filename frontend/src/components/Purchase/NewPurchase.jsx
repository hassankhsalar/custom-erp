  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setForm({ materialId: "", supplierId: "", quantity: "", unitPrice: "", totalPrice: 0 });
  ...
  return (
    <div style={container}>
      ...
      <form onSubmit={handleSubmit} style={formBox}>
        ...
        <button type="submit" style={button}>Add Purchase</button>
      </form>
...
const container = { maxWidth: "600px", margin: "2rem auto", padding: "1.5rem", background: "#fff", borderRadius: "10px", boxShadow: "0 2px 6px rgba(0,0,0,0.1)" };
...
const button = { padding: "10px", background: "#2563eb", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer" };
