...
export const API_ROUTES = {
  ...
  ACCOUNT_DEPOSIT: (id) => `${API_BASE_URL}/accounts/${id}/deposit`,
  ACCOUNT_WITHDRAW: (id) => `${API_BASE_URL}/accounts/${id}/withdraw`,
  ACCOUNT_TRANSFER: (id) => `${API_BASE_URL}/accounts/${id}/transfer`,
  ...
  CASHREGISTER_STATUS: (id) => `${API_BASE_URL}/cash-registers/${id}/status`,
  CASHREGISTER_DEPOSIT: (id) => `${API_BASE_URL}/cash-registers/${id}/add-cash`,
  CASHREGISTER_WITHDRAW: (id) => `${API_BASE_URL}/cash-registers/${id}/withdraw-cash`,
  CASHREGISTER_RECORDS: `${API_BASE_URL}/cash-registers/records`,
  CASHREGISTER_RECORDS_BY_ID: (id) => `${API_BASE_URL}/cash-registers/${id}/records`,
  ...
  REPORT_PURCHASE_SALES_OVERVIEW: `${API_BASE_URL}/reports/purchase-sales/overview`,
  REPORT_CUSTOMER: `${API_BASE_URL}/reports/customer`,
  REPORT_CUSTOMER_OVERVIEW: `${API_BASE_URL}/reports/customer/overview`,
  REPORT_SUPPLIER: `${API_BASE_URL}/reports/supplier`,
  REPORT_SUPPLIER_OVERVIEW: `${API_BASE_URL}/reports/supplier/overview`,
  REPORT_BEST_SELLING: `${API_BASE_URL}/reports/best-selling`,
  REPORT_BEST_SELLING_OVERVIEW: `${API_BASE_URL}/reports/best-selling/overview`,
  ...
  USER_SET_ACTIVE: (id) => `${API_BASE_URL}/users/${id}/active`,
  USER_GLOBAL_ACCESS_WINDOW: `${API_BASE_URL}/users/access-window/global`,
